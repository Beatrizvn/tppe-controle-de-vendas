...
export const AddCustomerModal = ({ isOpen, onClose, onConfirm, customerToEdit }: AddCustomerModalProps) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-50" onClick={onClose}>
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
        ...
        <form key={customerToEdit?.id || 'new-customer'} onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
